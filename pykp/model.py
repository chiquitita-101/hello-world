...
from pykp.ngrams import NGramers
from pykp.extractor.classifier import Extractor
class Seq2SeqModel(nn.Module):
    ...
    def __init__(self, opt):
        ...
        ##############!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        self.ngramers = NGramers(opt.word_vec_size, opt.word_vec_size, max_gram = 3, dropout = 0.5)
        self.extractor = Extractor(opt.word_vec_size)
    ...
    def forward(self, src, src_lens, input_tgt, src_oov, max_num_oov, src_mask):
        ...
        memory_bank, n_grams_f = self.ngramers(memory_bank)
        ext_res = self.extractor(n_grams_f)
        ...
        return ext_res, decoder_dist_all, attention_dist_all
